  ...
  return (
    ...
    {showMainContainer && (
           ...
           <div className={styles.main_container_cnbc_news}>
             ...
             <div className={styles.main_container_cnbc_news_img_1} onClick={handleCNBCNewsClick}>
               <img
                 className={styles.main_container_cnbc_news_img_1_arrow}
                 src="/svgs/Close.svg"
               />
               <p className={styles.main_container_anderson_cooper_img_2_arrow_text}>
                 Close
               </p>
             </div>
           </div>
             ...
             <div className={styles.main_container_anderson_cooper_card}>
               ...
               <div className={styles.main_container_anderson_cooper_desc}>
                 ...
                 <div className={styles.main_container_anderson_cooper_heading}>
                   <p
                     className={styles.main_container_anderson_cooper_heading_p_tag}
                   >
                     Anderson Cooper 360
                   </p>
                 </div>
